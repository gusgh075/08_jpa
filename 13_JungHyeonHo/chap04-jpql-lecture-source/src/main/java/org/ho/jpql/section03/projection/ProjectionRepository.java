package org.ho.jpql.section03.projection;
...
public class ProjectionRepository {
  ...
  *  */
  ...
  public List<CategoryInfo> newCommandProjection() {
    // 조회된 categoryCode와 categoryName으로 새로운 CategoryInfo객체를 만들겠다
    String jpql
        = "SELECT new org.ho.jpql.section03.projection.CategoryInfo(c.categoryCode, c.categoryName) " +
