...
public class MemberRegistService {
  ...
  // 오류가 생기면 rollback, 정상작동하면 commit
  ...
  @Transactional(
      isolation = Isolation.DEFAULT,  // 기능 전체를 트랜잭션 하나로 묶겠다.
      propagation = Propagation.REQUIRED, // 트랜잭션이 기존에 있다면 참여하겠다.
      rollbackFor = Exception.class // 해당 예외가 있으면 rollback 하겠다
  )
